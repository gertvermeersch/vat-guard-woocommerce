    ...
    private static function render_advanced_tab()
    {
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table" role="presentation">
                <tr>
                    ...
                    <td>
                        ...
                        <label for="eu_vat_guard_disable_exemption"><?php esc_html_e('Skip VAT exemption entirely and just register VAT numbers', 'eu-vat-guard-for-woocommerce'); ?></label>
                        <p class="description"><?php esc_html_e('When enabled, VAT numbers will be collected and validated but no tax exemption will be applied.', 'eu-vat-guard-for-woocommerce'); ?></p>
                    </td>
                </tr>
            </table>
            ...
            <table class="form-table" role="presentation">
                <tr>
                    <th scope="row">
                        <label for="eu_vat_guard_company_label"><?php esc_html_e('Company Name Label', 'eu-vat-guard-for-woocommerce'); ?></label>
                    </th>
                    <td>
                        <input type="text" id="eu_vat_guard_company_label" name="eu_vat_guard_company_label" 
                               value="<?php echo esc_attr(get_option('eu_vat_guard_company_label', '')); ?>" 
                               class="regular-text" placeholder="<?php esc_attr_e('Company Name', 'eu-vat-guard-for-woocommerce'); ?>" />
                        <p class="description"><?php esc_html_e('Custom label for the company name field. Leave empty to use default.', 'eu-vat-guard-for-woocommerce'); ?>
                ...
                <tr>
                    <th scope="row">
                        <label for="eu_vat_guard_vat_label"><?php esc_html_e('VAT Number Label', 'eu-vat-guard-for-woocommerce'); ?></label>
                    </th>
                    <td>
                        <input type="text" id="eu_vat_guard_vat_label" name="eu_vat_guard_vat_label" 
                               value="<?php echo esc_attr(get_option('eu_vat_guard_vat_label', '')); ?>" 
                               class="regular-text" placeholder="<?php esc_attr_e('VAT Number', 'eu-vat-guard-for-woocommerce'); ?>" />
                        <p class="description"><?php esc_html_e('Custom label for the VAT number field. Leave empty to use default.', 'eu-vat-guard-for-woocommerce'); ?>
                        <?php if (function_exists('icl_register_string')): ?>
                            <br><em><?php esc_html_e('This string will be registered with WPML for translation.', 'eu-vat-guard-for-woocommerce'); ?></em>
                        <?php endif; ?></p>
                    </td>
                ...
                <tr>
                    <th scope="row">
                        <label for="eu_vat_guard_exemption_message"><?php esc_html_e('VAT Exemption Message', 'eu-vat-guard-for-woocommerce'); ?></label>
                    </th>
                    <td>
                        <input type="text" id="eu_vat_guard_exemption_message" name="eu_vat_guard_exemption_message" 
                               ...
                               class="regular-text" placeholder="<?php esc_attr_e('VAT exempt for this order', 'eu-vat-guard-for-woocommerce'); ?>" />
                        <p class="description"><?php esc_html_e('Custom message shown when VAT exemption is applied. Leave empty to use default.', 'eu-vat-guard-for-woocommerce'); ?>
                        <?php if (function_exists('icl_register_string')): ?>
                            <br><em><?php esc_html_e('This string will be registered with WPML for translation.', 'eu-vat-guard-for-woocommerce'); ?></em>
                        <?php endif; ?></p>
                    </td>
        ...
        <div style="background: #fff3cd; border: 1px solid #ffeaa7; padding: 20px; margin: 20px 0; border-radius: 5px;">
            ...
            <ul style="margin-left: 20px;">
                <li><strong><?php esc_html_e('Disable VAT Exemption:', 'eu-vat-guard-for-woocommerce'); ?></strong> 
                    <?php esc_html_e('Useful if you only want to collect VAT numbers for record-keeping without applying tax exemptions.', 'eu-vat-guard-for-woocommerce'); ?></li>
                <li><strong><?php esc_html_e('Custom Labels:', 'eu-vat-guard-for-woocommerce'); ?></strong> 
                    <?php esc_html_e('Override default field labels to match your store\'s terminology or language preferences.', 'eu-vat-guard-for-woocommerce'); ?></li>
                <li><strong><?php esc_html_e('Custom Messages:', 'eu-vat-guard-for-woocommerce'); ?></strong> 
                    <?php esc_html_e('Customize the VAT exemption message shown to customers during checkout.', 'eu-vat-guard-for-woocommerce'); ?></li>
                <li><strong><?php esc_html_e('WPML Compatibility:', 'eu-vat-guard-for-woocommerce'); ?></strong> 
                    <?php esc_html_e('Custom strings are automatically registered with WPML for translation when saved.', 'eu-vat-guard-for-woocommerce'); ?></li>
            </ul>
        </div>
        ...
        <div style="background: #d1ecf1; border: 1px solid #bee5eb; padding: 20px; margin: 20px 0; border-radius: 5px;">
            ...
            <p><?php esc_html_e('WPML is active! Custom strings will be automatically registered for translation when you save them. You can translate them in:', 'eu-vat-guard-for-woocommerce'); ?></p>
    ...
    private static function render_documentation_tab()
    {
        ...
        <div style="max-width: 800px;">
            ...
            <div style="background: #e2e3e5; border: 1px solid #d6d8db; padding: 20px; margin: 20px 0; border-radius: 5px;">
                ...
                <a href="mailto:dev@stormlabs.be" style="color: #2271b1;">dev@stormlabs.be</a></p>
